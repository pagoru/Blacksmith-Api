...
import net.darkaqua.blacksmith.api.common.registry.IInterModRegistry;
...
import static net.darkaqua.blacksmith.mod.common.util.MCInterface.fromStorageHandler;
