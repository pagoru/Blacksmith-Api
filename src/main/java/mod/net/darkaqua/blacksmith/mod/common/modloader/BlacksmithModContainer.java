...
import net.darkaqua.blacksmith.api.common.modloader.ModSidedProxy;
import net.darkaqua.blacksmith.mod.common.registry.InterModRegistry;
...
public class BlacksmithModContainer extends FMLModContainerWrapper {
    ...
    public void constructMod(FMLConstructionEvent event) {
        ...
        try {
            for (Field f : clazz.getDeclaredFields()) {
                if (f.isAnnotationPresent(net.darkaqua.blacksmith.api.common.modloader.ModIdentifier.class)) {
