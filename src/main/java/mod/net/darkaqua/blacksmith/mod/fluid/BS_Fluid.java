...
public class BS_Fluid extends Fluid {
    ...
    public int getColor(FluidStack stack) {
        return definition.getColor(MCInterface.fromFluidStack(stack)).toIntWithAlpha();
    }
    ...
    public int getColor(World world, BlockPos pos) {
        return definition.getColor(new WorldRef(MCInterface.fromWorld(world), MCInterface.fromBlockPos(pos))).toIntWithAlpha();
    }
